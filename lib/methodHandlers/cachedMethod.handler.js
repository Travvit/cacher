...
class CachedMethodHandler {
    ...
    async apply(target, thisArg, argumentsList) {
        ...
        const ttl = foundMethod && foundMethod.ttl ? foundMethod.ttl : thisArg.options.ttl;
        // Save the key into the specified buckets or the global buckets if none specified
        const buckets = foundMethod && foundMethod.buckets ? foundMethod.buckets : thisArg.options.buckets;
