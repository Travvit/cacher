 ...
 * @class
 * @param {object} cacher the wrapper for the cacher object.
 * @param {object} hashFactory the hash factory.
 * @param {object} cacheHandlerFactory the factory to create a cacheHandler.
 * @param {object} passthroughHandlerFactory the factory to create a passthroughHandler.
 * @param {object} mutatorHandlerFactory the factory to create a mutatorHandler.
 */
class CachedObject {
