...
class CachedObject {
    constructor(cacher, hashFactory, cacheHandlerFactory, passthroughHandlerFactory, mutatorHandlerFactory) {
        this.cacheHandler = cacheHandlerFactory.create(cacher, hashFactory);
        this.passthroughHandler = passthroughHandlerFactory.create();
        this.mutatorHandler = mutatorHandlerFactory.create(cacher);
    }
