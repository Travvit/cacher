...
CacheManagerStub.purgeBuckets
    .withArgs({ app: 'tz-cacher', env: 'development', buckets: 'REDIS_UNAVAILABLE' })
    .rejects(new Error('Redis is not available.'));
CacheManagerStub.purgeBuckets
    .withArgs({ app: 'tz-cacher', env: 'development', buckets: undefined })
    .rejects(new Error('Invalid buckets format!'));
CacheManagerStub.purgeBuckets
    .withArgs({ app: 'tz-cacher', env: 'development', buckets: null })
    .rejects(new Error('Invalid buckets format!'));
CacheManagerStub.purgeBuckets
    .withArgs({ app: 'tz-cacher', env: 'development', buckets: sinon.match.array })
    .returns(true);
